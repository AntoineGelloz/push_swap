...
#    Updated: 2019/07/24 18:02:40 by agelloz          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC1 = checker.c functions.c get_next_line.c
SRC2 = push_swap.c functions.c selection_sort.c
OBJ1 = $(SRC1:%.c=%.o)
OBJ2 = $(SRC2:%.c=%.o)
